const ap = new APlayer({
    ...
    audio: [
	{
        name: "寂静之声",
        artist: '贵族乐团',
        url: 'https://asscreed.coding.net/p/AssCreed/d/AssCreed/git/blob/master/dist/寂静之声.mp3',
        cover: 'https://p1.music.126.net/Ix3X6A1jsuNR8NQNumhFlQ==/65970697683595.jpg?param=130y130',
      },
	  {
        name: "理想三旬",
        artist: '陈鸿宇',
        url: 'https://asscreed.coding.net/p/AssCreed/d/AssCreed/git/blob/master/dist/理想三旬.mp3',
      ...
      },
      {
        name: "倾城",
        artist: '许美静',
        url: 'https://asscreed.coding.net/p/AssCreed/d/AssCreed/git/blob/master/dist/倾城.mp3',
